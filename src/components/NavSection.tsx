...
function NavItem({ item, active }: NavItemProps) {
  ...
  const activeRootStyle = {
    ...
    bgcolor: alpha(currentTheme.palette.primary.main, currentTheme.palette.action.selectedOpacity),
                  ...
                  <ListItemIconStyle>
                    <Box
                      ...
                      sx={{
                        ...
                        transition: (selectedTheme) =>
                          selectedTheme.transitions.create('transform'),
                        ...(isActiveSub && {
                          transform: 'scale(2)',
